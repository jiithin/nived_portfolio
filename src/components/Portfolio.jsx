...
<div className="lg:flex md:flex items-center gap-2 bg-transparent justify-evenly  py-4 lg:px-20 px-10 pb-16 pt-6 rounded-lg hidden">
  ...
  <button
    className="cursor-pointer bg-neutral-800 relative inline-flex items-center justify-center gap-2 rounded-md text-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-orange-500 text-gray-300 hover:text-white lg:h-12 h-10 rounded-md lg:px-8 px-4"
  >
...
<div className="flex justify-center items-center min-h-full" key={index}>
    <div className="max-w-[720px] mx-auto">
        ...
        <a href={list.demo_url} target="_blank" rel="noopener noreferrer" className="block">
            <div className="relative m-0 h-[390px] overflow-hidden text-gray-700 bg-transparent rounded-none shadow-none bg-clip-border">
                <img
                     src={list.imge}
                     alt={list.title} />
            </div>
            ...
            <div className="flex items-center justify-between p-6">
                ...
                <p className="block font-sans text-md antialiased font-semibold leading-snug tracking-normal text-neutral-300">
                    Latest Project
                </p>
                </div>
                <p className="block font-sans text-md antialiased font-semibold leading-snug tracking-normal text-neutral-500">
                    {list.type}
                </p>
            </div>
        </div>
