      ...
      >
        ...
        >
          ...
          <p className="text-neutral-500 text-lg font-semibold text-center my-auto overflow-hidden">
            Responsible for creating the visual layout and user interface (UI)
            of an application, focusing on how users will navigate and interact
            with the app.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-neutral-500 text-lg font-semibold text-center my-auto overflow-hidden">
            Responsible for the visual design and layout of a website, focusing
            on how it looks and functions for users.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-neutral-500 text-lg font-semibold text-center my-auto overflow-hidden">
            Creative professional who uses visual elements like images, colors,
            and typography to communicate ideas and messages.
          </p>
        </motion.div>
      </motion.div>
    </div>
